...
contextBridge.exposeInMainWorld('api', {
  ...
  sendHome: (t, opts) => ipcRenderer.invoke('act:sendHome', t, opts),
  homeOptions: (t) => ipcRenderer.invoke('act:homeOptions', t),
  ...
  setLevel: (t, level) => ipcRenderer.invoke('act:setLevel', t, level),
